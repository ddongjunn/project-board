...
class ArticleServiceTest {
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        ...
        // When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "djlee", "title", "content", "hashtag"));
    ...
    void givenArticleIdAndModifiedInfo_whenUpdatingArticle_thenUpdatingArticle() {
        ...
        // When
        sut.updateArticle(1L, ArticleUpdateDto.of("update-title", "update-content", "change-hashtag"));
